  ...
  const features = [
    {
      ...
      description:
        "Creative brainstorming challenges and logical reasoning puzzles",
    },
    {
      icon: Clock,
      title: "30-Minute Timer",
      description:
        "Test your problem-solving skills under pressure with timed challenges",
    },
    {
      icon: Trophy,
      title: "Leaderboard",
      description:
        "Compete with other creative thinkers and see where you rank",
    },
    {
      icon: Users,
      title: "Guest & User Play",
      description:
        "Play as a guest or create an account to track your progress",
    },
  ];
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
            Test your creative thinking and logical reasoning skills with our
            comprehensive quiz. 25 carefully crafted questions covering
            brainstorming challenges and logic puzzles.
          </p>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Built for creative thinkers, problem solvers, and anyone who loves
            mental challenges.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((feature, index) => (
            <Card
              key={index}
              className="group hover:shadow-quiz-card-hover transition-all duration-300 border-border/50"
            >
      ...
      <section className="container mx-auto px-4 py-16 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-muted-foreground mb-8">
            Join thousands of creative thinkers and challenge yourself with our
            mind-bending quiz.
          </p>
